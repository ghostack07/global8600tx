...
--[[ Checking for Storage]]--
		...
		local npc = {"Haroudn", "Nah'Bobd"} -- names of npc's that will have this enabled
		local npc2 = {"Rashids"} -- names of npc's that will have this enabled
		local npc3 = {"Yamdan", "Aledsar"} -- names of npc's that will have this enabled
