...
keywordHandler:addKeyword({'ring'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I'm selling and buying energy rings, life rings, time rings, dwarven rings and rings of healing."})
