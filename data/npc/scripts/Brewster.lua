...
local talkstorage = 9912
local endstorage = 9901

if msgcontains(msg, 'wooden stake') then
	if getPlayerStorageValue(cid, endstorage) == 8 then
		npcHandler:say("Yes, I was informed what to do. Are you prepared to <hicks> receive my line of the prayer?", cid)
...
elseif msgcontains(msg, 'yes') then	
	if getPlayerStorageValue(cid, talkstorage) == 1 then
		...
		setPlayerStorageValue(cid, endstorage, 9)
