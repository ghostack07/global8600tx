local config = {
	...
	goldItems = {2148, 2152, 2160, 12651},
	itemsVIP = {12622, 12623, 12624, 12625, 12626, 12627, 12628, 12629, 12630, 12631, 12632, 12633, 12634, 12635, 12636, 12637, 12638, 12639, 12640, 12641, 12642, 12643, 12644, 12645, 12646, 12647, 12648, 12649, 12650},
}

local storageEx = 97114
local time = 4
