...
local nie = {x=32824, y=32231, z=12}
    if item.uid == 10001 then
        if getPlayerStorageValue(cid,10001) == -1 then
			...
			setPlayerStorageValue(cid,100097,2)
			...
			setPlayerStorageValue(cid, 100160, getPlayerStorageValue(cid, 100160) + 1)
		else
	...
	setPlayerStorageValue(cid,100098,2)
	...
	setPlayerStorageValue(cid,100099,2)
	...
	setPlayerStorageValue(cid,100100,2)
	...
	setPlayerStorageValue(cid,100101,2)
	...
	setPlayerStorageValue(cid,100102,2)
	...
	setPlayerStorageValue(cid,100103,2)
