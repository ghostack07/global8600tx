	...
	uint8_t toStackPos, Item* item, bool isHotkey, uint32_t creatureId/* = 0*/)
{
	...
	//std::cout << "[DEBUG] - useItemEx: itemId:" << itemi << std::endl;
	...
	// se for descomentar, comenta esse de baixo \/
	if (player->hasCondition(CONDITION_EXHAUST, 21)) {
		return false;
	}
	...
	//		itemi == 8704)
	//	{
	//		std::cout << "[DEBUG] - useItemEx: addCondition - EXHAUST_POTION - value:" << g_config.getNumber(ConfigManager::EX_ACTIONS_DELAY_INTERVAL) << std::endl;
	...
	//}
	//else {
	//	std::cout << "[DEBUG] - useItemEx: addCondition - 21 - value:" << g_config.getNumber(ConfigManager::EX_ACTIONS_DELAY_INTERVAL) << std::endl;
	...
	// se for descomentar, comenta o de baixo \/
	if (Condition * privCondition = Condition::createCondition(CONDITIONID_DEFAULT, CONDITION_EXHAUST, g_config.getNumber(ConfigManager::EX_ACTIONS_DELAY_INTERVAL), 0, false, 21))
		player->addCondition(privCondition);
